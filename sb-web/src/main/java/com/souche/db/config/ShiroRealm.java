...
import com.souche.db.service.impl.UPermissionServiceImpl;
import com.souche.db.service.impl.URoleServiceImpl;
import com.souche.db.service.impl.UUserServiceImpl;
...
//        String md5Pwd = new Md5Hash("123", "lucare",2).toString();
        if (hasUser != null) {
            ...
            List<URole> rlist = uRoleService.findRoleByUid(hasUser.getId());//获取用户角色
